...
if int(age) >= 2022:
    print(name, 'Invalid age Input, Restart the program to '
                'Re-enter your age. GoodLuck' .upper())
    print('error', exit())
print('Good morning ' + name, "you are " + str(x))
...
if x > 18:
    ...
    print(name, 'you are not yet to be an adult, '
                ...
                'The future is always bright young '+name.upper(), 'Have a Nice Day ')
